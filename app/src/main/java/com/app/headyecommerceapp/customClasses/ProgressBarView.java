package com.app.headyecommerceapp.customClasses;
...
/**
 * Created by Ashish S. Patil on 17-06-2016.
 */
public class ProgressBarView extends View {
    ...
    /**
     * The constructor for the ProgressBarView
     */
    ...
    private void setAnimationEnabled() {
        ...
        shouldAnimate = (int) animationValue != 0;
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius =
                (int) a.getDimension(R.styleable.ProgressBarView_matProg_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.ProgressBarView_matProg_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.ProgressBarView_matProg_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.ProgressBarView_matProg_rimWidth, rimWidth);

        float baseSpinSpeed =
                a.getFloat(R.styleable.ProgressBarView_matProg_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime =
                a.getInt(R.styleable.ProgressBarView_matProg_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.ProgressBarView_matProg_barColor, barColor);

        rimColor = a.getColor(R.styleable.ProgressBarView_matProg_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.ProgressBarView_matProg_linearProgress, false);

        if (a.getBoolean(R.styleable.ProgressBarView_matProg_progressIndeterminate, false)) {
            spin();
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isSpinning) {
            ...
            if ((int) mProgress != (int) mTargetProgress) {
            ...
            if ((int) oldProgress != (int) mProgress) {
                runCallback();
            }
    ...
    public void setInstantProgress(float progress) {
        ...
        if ((int) progress == (int) mTargetProgress) {
            return;
        }
